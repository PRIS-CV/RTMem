...
from RTMem.models.dsbn import convert_dsbn, convert_bn
from RTMem.evaluators import Evaluator
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str,
                        default="/market-res50/logs/model_best.pth.tar",
                        metavar='PATH')
    # testing configs
